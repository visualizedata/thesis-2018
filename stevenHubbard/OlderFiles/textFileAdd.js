...
var content = JSON.parse(fs.readFileSync('reAppPath.json','utf8')); //

//create object to load content 

content.forEach( function(d, i) {
    var backText = fs.readFileSync('reAppTextFiles/'+ d.text_back,'UTF16');
    console.log('reAppTextFiles/'+ d.text_back)
