...
var obj = JSON.parse(fs.readFileSync('SeparatePages/completeForks2.json', 'utf8'));
...
async.eachSeries(obj, function(value, callback) {
    ...
    setTimeout(callback, 10);
        ...
        setTimeout(callback2, 250);
            ...
            fs.writeFileSync('SeparatePages/topicsDescForks.json', JSON.stringify(collection2));
    });
