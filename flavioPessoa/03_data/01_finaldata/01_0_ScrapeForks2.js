...
async.eachSeries(indPaginas, function(value, callback) {
  var apiRequest = 'https://api.github.com/search/repositories?q=forks%3A%3E%3D1000&page=' + value;
  var urlOpt = {
    url: apiRequest,
  ...
  setTimeout(callback, 6000);
    ...
    fs.writeFile('SeparatePages/completeForks2.json', JSON.stringify(select500));
});